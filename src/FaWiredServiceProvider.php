...
class FaWiredServiceProvider extends ServiceProvider
{
     ...
     */
    public static function asset(string $file = 'fa-wired.js'): string
    {
...
// Global helper function (outside the namespace)
if (! function_exists('fa_wired_asset')) {
    ...
    {
        return \Kerkness\FaWired\FaWiredServiceProvider::asset($file);
    }
}